...
public interface CategoryRepository {
    ...
    List<Category> findByIdsAndUserId(UUID userId, List<UUID> categoryIds);
    ...
    boolean existsActiveByUserIdAndNameExcludingId(UUID userId, String name, UUID excludeId);
}