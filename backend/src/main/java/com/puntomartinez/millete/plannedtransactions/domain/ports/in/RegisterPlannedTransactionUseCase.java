...
public interface RegisterPlannedTransactionUseCase {

    PlannedTransaction register(RegisterPlannedTransactionCommand command);

    record RegisterPlannedTransactionCommand(
            UUID userId,
            UUID categoryId,
            BigDecimal amount,
