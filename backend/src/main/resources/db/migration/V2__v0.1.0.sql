...
ALTER TABLE family_invitations
    ADD COLUMN inviter_user_id UUID,
...
CREATE INDEX idx_invitations_invited ON family_invitations(invited_user_id, status);
CREATE INDEX idx_invitations_family_status ON family_invitations(family_id, status);