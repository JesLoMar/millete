...
@DisplayName("WithdrawFromGoalCommand")
class WithdrawFromGoalCommandTest {
    ...
    void shouldCreateValidCommand() {
        assertThatCode(() ->
                new WithdrawFromGoalCommand(GOAL_ID, USER_ID, BigDecimal.TEN)
    ...
    void shouldRejectNullGoalId() {
        assertThatThrownBy(() ->
                new WithdrawFromGoalCommand(null, USER_ID, BigDecimal.TEN)
    ...
    void shouldRejectNullUserId() {
        assertThatThrownBy(() ->
                new WithdrawFromGoalCommand(GOAL_ID, null, BigDecimal.TEN)
        ).isInstanceOf(InvalidInputException.class);
    }
    ...
    void shouldRejectNonPositiveAmount(String amount) {
        assertThatThrownBy(() ->
                new WithdrawFromGoalCommand(GOAL_ID, USER_ID, new BigDecimal(amount))
        ).isInstanceOf(InvalidInputException.class);
    }
    ...
    void shouldRejectNullAmount() {
        assertThatThrownBy(() ->
                new WithdrawFromGoalCommand(GOAL_ID, USER_ID, null)
        ).isInstanceOf(InvalidInputException.class);
    }
}