...
export const EXPORT_ENTITY_TYPES = [
  ...
  {
    value: 'investments',
    labelKey: 'entities.investments',
  },
  {
    value: 'savingsgoals',
    labelKey: 'entities.savingsGoals',
  },
]
...
export const EXPORT_PERIOD_OPTIONS = [
  {
    value: '1m',
    labelKey: 'export.period1m',
  },
  {
    value: '3m',
    labelKey: 'export.period3m',
  },
  {
    value: '6m',
    labelKey: 'export.period6m',
  },
  {
    value: '1y',
    labelKey: 'export.period1y',
  },
]