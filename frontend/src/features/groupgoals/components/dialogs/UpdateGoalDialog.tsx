...
export function UpdateGoalDialog({
  ...
  const [editedMonthlyTarget, setEditedMonthlyTarget] =
    useState<string | null>(null)

  const [editedDistributionMode, setEditedDistributionMode] =
    useState<string | null>(null)

  const monthlyTarget =
    editedMonthlyTarget ??
    (currentMonthlyTarget > 0
      ? currentMonthlyTarget.toString()
      : '')

  const distributionMode =
    editedDistributionMode ?? currentDistributionMode
          ...
          <div className="py-2 sm:py-4 space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  value={monthlyTarget}
                  onChange={(e) =>
                    setEditedMonthlyTarget(e.target.value)
                  }
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setEditedDistributionMode(value)
                }
              >
                ...
                <SelectContent className="bg-card border-border">
                  <SelectItem value="EQUITATIVE">
                    {t('groupGoals:modes.equitative')}
                  </SelectItem>

                  <SelectItem value="PROPORTIONAL">
                    {t('groupGoals:modes.proportional')}
                  </SelectItem>

                  <SelectItem value="CUSTOM">
                    {t('groupGoals:modes.custom')}
                  </SelectItem>
                </SelectContent>
              </Select>
            </div>
