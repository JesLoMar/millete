...
import { Crown, Edit2, MoreHorizontal, Trash2 } from 'lucide-react'
      ...
      <CardContent className="p-4 sm:p-6 relative">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  ...
                  aria-label={t('groupGoals:memberOptions', {
                    name: member.name,
                  })}
                >
                  <MoreHorizontal
        ...
        <div className="space-y-1.5 sm:space-y-2">
          ...
          <ProgressBar
            ...
            ariaLabel={t('groupGoals:memberProgress', {
              name: member.name,
            })}
          />
        </div>
